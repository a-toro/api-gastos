...
// Exmaple -> http://localhost:5001/ExpensesCategory 
[ApiController]
[Route("ExpensesCategory")]
public class ExpensesCategoryController : ControllerBase
{

    private readonly IRepository<ExpenseCategory> itemsRepository;

    public ExpensesCategoryController(IRepository<ExpenseCategory> itemsRepository)
    {
